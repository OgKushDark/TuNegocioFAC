        ...
        <div class="modal fade" id="ModalFicha" tabindex="-1" role="dialog">
            ...
            <div class="modal-dialog" style="width: 980px">
                ...
                <div class="modal-content">
                    <form name="frmFichaComite" id="frmFichaComite" method="POST">
                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="cbxComite" id="cbxComite" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required onchange="obtenerDataPorComite()">
                                                            </select>
                                                        </div>
                                                        <br><br>
                                                        <div class="col-md-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label><b>
                                                                <h3>1.- DATOS DE LOS RESPONSABLES</h3>
                                                            </b></label>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label><b>
                                                                <h3>2.- DATOS DEL COMITÉ VASO DE LECHE</h3>
                                                            </b></label>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label><b>
                                                                <h3>3.- CONTROL DE STOCK EN ALMACÉN</h3>
                                                            </b></label>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label><b>
                                                                <h3>4.- CONDICIONES DE HIGIENE Y PREPARACIÓN</h3>
                                                            </b></label>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxCondicionProducto" id="cbxCondicionProducto" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxCondicionPreparacion" id="cbxCondicionPreparacion" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxHigieneUtensilios" id="cbxHigieneUtensilios" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label><b>
                                                                <h3>5.- ALMACENAMIENTO DE LOS ALIMENTOS EN LOS ALIMENTOS DE LOS COMITES DE VASO DE LECHE</h3>
                                                            </b></label>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxApilado" id="cbxApilado" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxHumedad" id="cbxHumedad" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxSeguridad" id="cbxSeguridad" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxVentilacion" id="cbxVentilacion" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxIluminacion" id="cbxIluminacion" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-2">
                                                        <select name="cbxLimpieza" id="cbxLimpieza" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        SI&nbsp;<label class="cr-styled" for="rdbResolucionMunicipalSi">
                                                            <input type="radio" name="rdbResolucionMunicipalSiNo" id="rdbResolucionMunicipalSi" value="1"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        NO&nbsp;<label class="cr-styled" for="rdbResolucionMunicipalNo">
                                                            <input type="radio" name="rdbResolucionMunicipalSiNo" id="rdbResolucionMunicipalNo" value="0"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-2">
                                                        SI&nbsp;<label class="cr-styled" for="rdbActaInstalacionSi">
                                                            <input type="radio" name="rdbActaInstalacionSiNo" id="rdbActaInstalacionSi" value="1"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        NO&nbsp;<label class="cr-styled" for="rdbActaInstalacionNo">
                                                            <input type="radio" name="rdbActaInstalacionSiNo" id="rdbActaInstalacionNo" value="0"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-2">
                                                        SI&nbsp;<label class="cr-styled" for="rdbLibroActasSi">
                                                            <input type="radio" name="rdbLibroActasSiNo" id="rdbLibroActasSi" value="1"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        NO&nbsp;<label class="cr-styled" for="rdbLibroActasNo">
                                                            <input type="radio" name="rdbLibroActasSiNo" id="rdbLibroActasNo" value="0"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-2">
                                                        SI&nbsp;<label class="cr-styled" for="rdbCartelIdentificacionSi">
                                                            <input type="radio" name="rdbCartelIdentificacionSiNo" id="rdbCartelIdentificacionSi" value="1"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        NO&nbsp;<label class="cr-styled" for="rdbCartelIdentificacionNo">
                                                            <input type="radio" name="rdbCartelIdentificacionSiNo" id="rdbCartelIdentificacionNo" value="0"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-2">
                                                        SI&nbsp;<label class="cr-styled" for="rdbSelloComiteSi">
                                                            <input type="radio" name="rdbSelloComiteSiNo" id="rdbSelloComiteSi" value="1"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                    <div class="col-md-2">
                                                        NO&nbsp;<label class="cr-styled" for="rdbSelloComiteNo">
                                                            <input type="radio" name="rdbSelloComiteSiNo" id="rdbSelloComiteNo" value="0"><i class="fa"></i>
                                                        </label>
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label><b>
                                                                <h3>7.- CONTROL DE DOCUMENTACIÓN</h3>
                                                            </b></label>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="cbxControlDocumentacion" id="cbxControlDocumentacion" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="cbxControlBeneficiarios" id="cbxControlBeneficiarios" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="cbxParticipacion" id="cbxParticipacion" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="cbxApoyoGastos" id="cbxApoyoGastos" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="cbxAsistenciaAsamblea" id="cbxAsistenciaAsamblea" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="cbxAsistenciaActividad" id="cbxAsistenciaActividad" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                    <br><br>
                                                    <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="cbxDesarrolloParticipacion" id="cbxDesarrolloParticipacion" class="form-control selectpicker" data-live-search="true" title="Seleccione opción" required>
                                                        </select>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label><b>
                                                                    <h3>8.- OBSERVACIONES Y RECOMENDACIONES GENERALES DE LA SUPERVISIÓN</h3>
                                                                </b></label>
                                                            <textarea name="txtObservacion" id="txtObservacion" class="form-control" rows="3" style="border:solid 1px">
                                                    </textarea>
                                                        </div>
                                                    </div>
                                                </div>
